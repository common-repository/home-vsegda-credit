...
class Home_Vsegda_Credit_Helpers {
	...
	public static function get_options() {
		$options                       = array();
		$options['partnerCode']        = ! empty( get_option( 'woocommerce_home_vsegda_credit_partnerCode' ) ) ?
			esc_attr( get_option( 'woocommerce_home_vsegda_credit_partnerCode' ) ) :
			'';
		$options['partnerProductCode'] = ! empty( get_option( 'woocommerce_home_vsegda_credit_partnerProductCode' ) ) ?
			esc_attr( get_option( 'woocommerce_home_vsegda_credit_partnerProductCode' ) ) :
			'';
		$options['onNewWindow']        = 'yes' === static::validate_checkbox_option( get_option( 'woocommerce_home_vsegda_credit_buttonOpenOnNewWindow' ) ) ?
			'_blank' :
			'_self';
